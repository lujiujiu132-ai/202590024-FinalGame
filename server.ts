  ...
  const variations: Record<string, {
    ...
    Butler: {
      alibi: {
        ...
        CN: [
          ...
          "23:10以后我绝对合衣安歇在我的卧室，我这个年纪一旦睡沉了，周遭的水流声或其它异动根本听不见分毫。",
      ...
      conspiracy: {
        ...
        CN: [
          ...
          "外访 of standard visitor, 珠宝评估商卡特携带着奇怪的凌晨船票，半夜不眠，他跟任何人都不曾提及他真实的意图。",
    ...
    Maid: {
      alibi: {
        ...
        CN: [
          "当晚23:10至23:25分，我正跪在走廊东端全力擦洗地垫上的顽固橘子汁印记，一抬头正好注意到了管家探头探脑的怪异姿势。",
    ...
    Visitor: {
      alibi: {
        ...
        CN: [
          ...
          "我整晚都没有迈出客休区，更不曾在所谓的 23:15 分向该死的管家讨取备用化学钥匙，这纯属无端指责。"
        ],
        EN: [
      ...
      general: {
        ...
        CN: [
          ...
          "我已经在首要答复中把底牌展示清楚。关于那些莫名其妙的小卡片线索，我全不知情，也请少安毋躁。"
        ],
        EN: [
      ...
      outburst: {
        ...
        CN: [
          "胡说八道！搜出了出境班联单又说明得了什么？！这仅仅是我的次级备用商业出行合同罢了！管家拿了我的美金同意睁一只眼闭一只眼，但我下地窖开箱时锁早特么被人熔成了浆糊！真正的劫匪在你们身边！",
    ...
    Niece: {
      ...
      jewel: {
        ...
        CN: [
          ...
          "圣物吊坠被邪恶的心灵和债务缠死，也许它已经被扔进了某些隐秘的死角或污水槽里，远离这场无休止的争夺纠缠才好！"
        ],
        EN: [
      ...
      motive: {
        ...
        CN: [
          ...
          "要是能把吊坠变现换钱，我的偏头痛 and 对这栋牢房的终生窒息感也会瞬间治愈。可终究，我还是在罪恶之夜当了逃兵。"
        ],
        EN: [
    ...
    Doctor: {
      alibi: {
        ...
        CN: [
          ...
          "案发关键的23:15时分，我在地底专心操作恒温离心罐，地窖隔音十分强。走廊大院发生的任何脚步、放水沟通音，我一概置若罔闻。"
        ],
        EN: [
      ...
      jewel: {
        ...
        CN: [
          ...
          "失窃的红ruby一旦通过物理手段剥除外部微刻封环，其价值会毁灭大半。除非有行家懂得在地下无尘实验室重新打磨切割。"
        ],
        EN: [
      ...
      outburst: {
        ...
        CN: [
          "你们居然去翻开了地窖下的旧酒箱，翻出了我的债务到期通知？！……一派胡言！没错，我确实面临着重大的实验基建借贷纠纷，但这根本不足以支撑熔毁锁具的高浓度环己烷是我携带进来的！这纯是主管推理，毫无微观药学残留论证！",
