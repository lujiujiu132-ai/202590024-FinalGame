  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-64 flex flex-col items-center shrink-0">
        <div className="w-44 h-64 md:w-56 md:h-[360px] bg-[#090b10] border-2 rounded-xl flex items-center justify-center overflow-hidden relative group border-zinc-800">
          <img
      ...
      <div className="flex-1 flex flex-col justify-between overflow-hidden">
        ...
        {/* Chat History Panel */}
        <div className="h-64 md:h-[320px] overflow-y-auto border border-zinc-805 bg-[#090b10] rounded-xl p-3.5 md:p-4 flex flex-col gap-2.5 scrollbar-thin">
